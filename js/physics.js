...
const Physics = {
    ...
    step() {
        ...
        /*
         * Snapshot the pancake's pre-step transform for render
         * interpolation before Matter advances it.
         */

        if (
            typeof Pancake !== 'undefined' &&
            typeof Pancake.snapshotPreviousState === 'function'
        ) {
            Pancake.snapshotPreviousState();
        }
