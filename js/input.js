...
const Input = {
    ...
    onPointerDown(event) {
        ...
        /*
         * Defense-in-depth: also resume audio here, not just on
         * the Start button. Some mobile browsers only truly
         * unlock AudioContext on the gesture that directly
         * precedes the sound, not an earlier click. Idempotent —
         * resume() is a no-op once the context isn't suspended.
         */
