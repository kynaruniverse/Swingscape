...
const styles = StyleSheet.create({
  ...
  bookend: { color: "#fff", fontSize: 24, fontFamily: "DMSerifDisplay_400Regular", letterSpacing: 0.5 },
  ...
  bestPanelScore: { fontSize: 22, fontFamily: "DMSerifDisplay_400Regular", marginTop: 2 },
  ...
  resultWord: { color: "#fff", fontSize: 22, fontFamily: "DMSerifDisplay_400Regular", marginTop: 6, letterSpacing: 0.5 },
  resultScore: { fontSize: 30, fontFamily: "DMSerifDisplay_400Regular", marginTop: 4 },
  ...
  endBestWord: { color: "#fff", fontSize: 32, fontFamily: "DMSerifDisplay_400Regular", marginTop: 8, letterSpacing: 0.5 },
  endBestScore: { fontSize: 48, fontFamily: "DMSerifDisplay_400Regular", marginTop: 10 },
